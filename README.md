...
│   └── CARIOCA.md          Secuencias y funcionamiento de Carioca
└── tests/
    ├── scoring.test.cjs   Pruebas de cálculo
    └── carioca.test.cjs   Pruebas de objetivos de Carioca
```
...
En «Tu propio juego» puedes elegir rondas o categorías con multiplicadores positivos o negativos y guardar las reglas para reutilizarlas. Carioca muestra la combinación de cada ronda: ofrece diez rondas, siete o una secuencia personalizada. La novena ronda de la secuencia inicial es Escala sucia y la décima, Escala real. Puedes editar los nombres, las descripciones y el orden antes de jugar. Consulta [la guía de Carioca](docs/CARIOCA.md).

Los valores de cartas, fichas y cierres se acuerdan en la mesa. Los puntajes se ingresan manualmente. Las partidas anteriores sin objetivos conservan sus reglas.
