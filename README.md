...
- elegir el tipo de juego: puntos con tope, acumulativo, Catán o 7 Wonders;
...
- calcular la puntuación final de 7 Wonders por Maravilla, tesorería, conflictos, cartas civiles, comerciales, científicas y gremios;
- optimizar automáticamente los símbolos científicos a elección y aplicar el desempate por monedas;
- revisar una tabla compacta con la clasificación completa en todos los modos y abrir la ficha de cada jugador para actualizarla sin recorrer una página extensa.
...
- **Calculadora de 7 Wonders:** admite las partidas estándar de 3 a 7 jugadores, muestra primero el resumen ordenado y abre una ficha individual al seleccionar uno. Suma los puntos del tablero de Maravilla y de las cartas azules, amarillas y moradas; convierte cada 3 monedas en 1 PV; calcula las fichas militares de −1, +1, +3 y +5; y resuelve automáticamente la ciencia con cuadrados, conjuntos completos y símbolos a elección. El mayor puntaje gana y, en empate, se ordena por monedas restantes.
