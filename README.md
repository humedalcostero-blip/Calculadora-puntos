...
- **Calculadora de Catán:** permite elegir cualquier meta de victoria. Catán base incluye poblados (1 PV), ciudades (2 PV), cartas o fichas de victoria, Gran Carretera/Ruta Comercial y Gran Ejército. Navegantes habilita puntos especiales de escenario; Ciudades y Caballeros agrega metrópolis, Defensor de Catán, Mercader, caballeros activos, fuerza bárbara y defensa de la isla. También incluye un ajuste manual para otras expansiones y reglas especiales.
