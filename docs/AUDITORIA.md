...
Actualización del 13 de septiembre de 2026: Carioca incorpora objetivos por ronda, variantes de diez y siete rondas y secuencias personalizadas. Escala sucia ocupa la ronda 9 y Escala real la 10 en la secuencia inicial solicitada. Se añadieron 11 pruebas: ahora pasan 34. Las partidas anteriores sin objetivos mantienen sus reglas. Consulta [la guía de esta actualización](CARIOCA.md). Se entrega en los archivos locales y el paquete para GitHub; no se publicó.
